...
screen = Screen()
screen.title('Turtle Race 1.0')
screen.setup(width=500, height=400)
screen.setworldcoordinates(llx=0, lly=-200, urx=500, ury=200)
user_bet = screen.textinput(title='Place your bet', prompt='Which turtle do you bet on? (purple, blue, green, light green, orange or red)')
...
print(f'You {res}. The winner was {winner_color}.')
input()